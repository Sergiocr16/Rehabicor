...
public class AppUser implements Serializable {
    ...
    public AppUser authorityType(Integer authorityType) {
    ...
    public AppUser status(Integer status) {
        this.status = status;
        return this;
    }
    ...
    public AppUser rehabilitationCenter(RehabilitationCenter rehabilitationCenter) {

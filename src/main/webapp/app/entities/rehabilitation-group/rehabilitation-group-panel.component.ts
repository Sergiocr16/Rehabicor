...
@Component({
    selector: 'jhi-rehabilitation-group-panel',
    templateUrl: './rehabilitation-group-panel.component.html'
})
export class RehabilitationGroupPanelComponent implements OnInit {
    ...
    selectSesion(e) {
        ...
        this.lineChartColorsSessionMinor = [
            {
                borderColor: '#8c24a8',
                backgroundColor: 'rgba(140, 36, 168, 0.52)'
            },

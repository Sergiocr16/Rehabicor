...
describe('Service Tests', () => {
    describe('ComorbiditiesPatient Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new ComorbiditiesPatient(0, 'AAAAAAA', false, 0);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a ComorbiditiesPatient', async () => {
                ...
                service
                    .create(new ComorbiditiesPatient(null))
                    .pipe(take(1))
            ...
            it('should update a ComorbiditiesPatient', async () => {
                const returnedFromService = Object.assign(
                    {
                        description: 'BBBBBB',
                        exist: true,
                        comorbiditieRelation: 1
                    },
                    elemDefault
                );
            ...
            it('should return a list of ComorbiditiesPatient', async () => {
                const returnedFromService = Object.assign(
                    {
                        description: 'BBBBBB',
                        exist: true,
            ...
            it('should delete a ComorbiditiesPatient', async () => {

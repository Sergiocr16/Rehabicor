...
describe('Service Tests', () => {
    describe('NonSpecificPainsSession Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new NonSpecificPainsSession(0, 'AAAAAAA', false, 0);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a NonSpecificPainsSession', async () => {
            ...
            it('should update a NonSpecificPainsSession', async () => {
                const returnedFromService = Object.assign(
                    {
                        description: 'BBBBBB',
                        exist: true,
                        nonSpecificPainsSessionRelation: 1
                    },
                    elemDefault
                );
            ...
            it('should return a list of NonSpecificPainsSession', async () => {
                const returnedFromService = Object.assign(
                    {
                        description: 'BBBBBB',
                        exist: true,
            ...
            it('should delete a NonSpecificPainsSession', async () => {

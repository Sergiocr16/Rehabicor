...
import { InitialAssessmentComponent } from 'app/entities/initial-assessment/initial-assessment.component';
...
describe('Component Tests', () => {
    describe('InitialAssessment Management Component', () => {
        let comp: InitialAssessmentComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(InitialAssessmentComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new InitialAssessment(123)],
                        headers
                    })
                )
            );
            ...
            expect(comp.initialAssessments[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
